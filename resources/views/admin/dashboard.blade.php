...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .stat-card:hover { transform: translateY(-5px); box-shadow: 0 12px 32px rgba(15,23,42,0.12); }
        ...
        .trend-neu { background: rgba(100,116,139,0.1); color: #64748b; }
        ...
        /* Color themes */
        .theme-blue .stat-ico { background: rgba(59,130,246,0.1); color: var(--accent); }
        .theme-blue .glow { background: var(--accent); }
        .theme-blue .stat-bar-fill { background: linear-gradient(90deg, var(--accent), var(--accent-2)); }

        .theme-green .stat-ico { background: rgba(16,185,129,0.1); color: var(--success); }
        .theme-green .glow { background: var(--success); }
        .theme-green .stat-bar-fill { background: linear-gradient(90deg, var(--success), #34d399); }

        .theme-orange .stat-ico { background: rgba(245,158,11,0.1); color: var(--warning); }
        .theme-orange .glow { background: var(--warning); }
        .theme-orange .stat-bar-fill { background: linear-gradient(90deg, var(--warning), #fbbf24); }

        .theme-purple .stat-ico { background: rgba(139,92,246,0.1); color: var(--purple); }
        .theme-purple .glow { background: var(--purple); }
        .theme-purple .stat-bar-fill { background: linear-gradient(90deg, var(--purple), #a78bfa); }
        ...
        .sc-body { padding: 1.5rem 1.75rem; }
        .sc-body-p0 { padding: 0; }
        ...
        .badge-fully { background: rgba(99,102,241,0.1); color: var(--accent-2); }
        .badge-partial { background: rgba(59,130,246,0.1); color: var(--accent); }
        .badge-one { background: rgba(245,158,11,0.1); color: var(--warning); }
        .badge-kaprodi { background: rgba(16,185,129,0.1); color: var(--success); }
        .badge-wadek { background: rgba(59,130,246,0.1); color: var(--accent); }
        .badge-warek { background: rgba(99,102,241,0.1); color: var(--accent-2); }
        .badge-puskaka { background: rgba(139,92,246,0.1); color: var(--purple); }
        ...
        .btn-act-edit { border-color: #e2e8f0; background: white; color: #475569; }
        .btn-act-edit:hover { border-color: var(--accent); color: var(--accent); }

        .btn-act-del { border-color: rgba(239,68,68,0.2); background: rgba(239,68,68,0.05); color: var(--danger); }
        .btn-act-del:hover { background: rgba(239,68,68,0.1); }

        .btn-act-approve { border-color: rgba(16,185,129,0.3); background: rgba(16,185,129,0.05); color: var(--success); }
        .btn-act-approve:hover { background: rgba(16,185,129,0.1); }

        .btn-act-reject { border-color: rgba(239,68,68,0.3); background: rgba(239,68,68,0.05); color: var(--danger); }
        .btn-act-reject:hover { background: rgba(239,68,68,0.1); }
        ...
        .val-item:hover { border-color: rgba(59,130,246,0.2); background: #fafbff; }
        ...
        .val-info small { font-size: 0.72rem; color: #94a3b8; }
        ...
        .sc:nth-child(4) { animation-delay: 0.25s; }

        /* Number counter animation */
        .count-up { animation: countUp 0.1s ease; }
    </style>
</head>
...
<aside class="sidebar" id="mainSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-group">
            ...
            <div class="nav-item">
                <a href="{{ route('dashboard.admin') }}" class="nav-link active" id="nav-dashboard">
            ...
            <div class="hero-banner">
                <div class="hero-content">
                    ...
                    <div class="hero-chips">
                        ...
                        <span class="hero-chip"><i class="bi bi-clock"></i> {{ now()->format('d M Y, H:i') }} WIB</span>
                        <span class="hero-chip"><i class="bi bi-circle-fill" style="color:#10b981; font-size:0.5rem;"></i> Sistem Online</span>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-xl-5">
                    <div class="sc">
                        <div class="sc-head">
                            <h3 class="sc-title">
                                <div class="sc-title-icon" style="background:rgba(99,102,241,0.1); color:#6366f1;"><i class="bi bi-pie-chart-fill"></i></div>
                                Distribusi Beasiswa
                            </h3>
                        </div>
                        <div class="sc-body">
                            <div class="d-flex gap-4 align-items-center mb-4">
                                <div style="position:relative; width:110px; height:110px;">
                                    ...
                                    <div style="position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; pointer-events:none;">
                                        <span style="font-size:1.5rem; font-weight:900; color:#0f172a; line-height:1;">{{ $stats['total_beasiswa'] ?? 0 }}</span>
                                ...
                                <div style="flex:1;">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        ...
                                        <strong style="font-size:1rem; color:#0f172a;">{{ $stats['fully_funded'] ?? 0 }}</strong>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <div class="d-flex align-items-center gap-2">
                                        ...
                                        <strong style="font-size:1rem; color:#0f172a;">{{ $stats['partially_funded'] ?? 0 }}</strong>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <strong style="font-size:1rem; color:#0f172a;">{{ $stats['one_shoot'] ?? 0 }}</strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="border-top:1px solid #f1f5f9; padding-top:1rem;">
                                <div style="font-size:0.72rem; font-weight:700; text-transform:uppercase; letter-spacing:0.08em; color:#94a3b8; margin-bottom:8px;">Distribusi Role Pejabat</div>
                                <div class="d-flex gap-3">
                                    ...
                                    <div style="flex:1; text-align:center;">
                                        <div style="height:50px; display:flex; align-items:flex-end; justify-content:center; margin-bottom:6px;">
                                            <div style="width:28px; border-radius:6px 6px 0 0; background:{{$r['color']}}; height:{{ max(8, round(($r['val']/$maxRole)*50)) }}px; transition:all 1.2s ease; opacity:0.85;"></div>
                                        </div>
                                        <div style="font-size:1rem; font-weight:800; color:#0f172a;">{{ $r['val'] }}</div>
                ...
                <div class="col-xl-7">
                    <div class="sc">
                        <div class="sc-head">
                            <h3 class="sc-title">
                                <div class="sc-title-icon" style="background:rgba(59,130,246,0.1); color:#3b82f6;"><i class="bi bi-award-fill"></i></div>
                                Program Beasiswa Terbaru
                                <span class="badge-pill badge-active ms-2" style="font-size:0.65rem;" id="liveIndicator">● Live</span>
                            </h3>
                            <a href="{{ route('admin.beasiswa.index') }}" class="btn-prem" style="font-size:0.78rem; padding:0.4rem 1rem;">
                        ...
                        <div class="sc-body-p0">
                            <div class="beasiswa-grid" style="padding:1.25rem 1.5rem;" id="realtimeBeasiswa">
                                ...
                                <div class="beasiswa-card">
                                    <div class="bc-top">
                                        <div class="bc-icon" style="{{ $iconColor }}"><i class="bi {{ $iconClass }}"></i></div>
                                        <span class="badge-pill {{ $badgeClass }}">{{ $b->kategori_label }}</span>
                                    </div>
                                    <div>
                                        <div class="bc-name">{{ $b->nama_beasiswa }}</div>
                                        <div class="bc-source"><i class="bi bi-building"></i> {{ $b->sumber_dana }}</div>
                                    </div>
                                    <div class="bc-nominal">{{ $b->nominal_rupiah }}</div>
                                    <div class="bc-footer">
                                        <span class="badge-pill {{ $b->is_active ? 'badge-active' : 'badge-inactive' }}">
                                ...
                                <div style="grid-column:1/-1; text-align:center; padding:3rem; color:#94a3b8;">
                                    ...
                                    Belum ada program beasiswa. <a href="{{ route('admin.beasiswa.index') }}" style="color:var(--accent);">Tambah sekarang</a>
                                </div>
                                @endforelse
                            </div>
                        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-xl-6">
                    <div class="sc">
                        <div class="sc-head">
                            <h3 class="sc-title">
                                <div class="sc-title-icon" style="background:rgba(245,158,11,0.1); color:#f59e0b;"><i class="bi bi-file-earmark-check-fill"></i></div>
                                Antrean Validasi SK
                            </h3>
                        ...
                        <div class="sc-body">
                            <div class="val-item" style="animation-delay:0.1s;">
                                <div class="val-icon" style="background:rgba(59,130,246,0.1); color:#3b82f6;"><i class="bi bi-file-text-fill"></i></div>
                                <div class="val-info">
                            ...
                            <div class="val-item" style="animation-delay:0.15s;">
                                <div class="val-icon" style="background:rgba(99,102,241,0.1); color:#6366f1;"><i class="bi bi-file-text-fill"></i></div>
                                <div class="val-info">
                            ...
                            <div class="val-item" style="animation-delay:0.2s;">
                                <div class="val-icon" style="background:rgba(16,185,129,0.1); color:#10b981;"><i class="bi bi-file-text-fill"></i></div>
                                <div class="val-info">
                            ...
                            <div style="text-align:center; margin-top:0.75rem;">
                                <button class="btn-act btn-act-edit" style="width:100%; justify-content:center;">Lihat Semua Antrean</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6">
                    <div class="sc">
                        <div class="sc-head">
                            <h3 class="sc-title">
                                <div class="sc-title-icon" style="background:rgba(100,116,139,0.1); color:#64748b;"><i class="bi bi-journal-text"></i></div>
                        ...
                        <div class="sc-body">
                            <div class="timeline">
                                <div class="tl-item">
                                    ...
                                    <div class="tl-card">
                                        <strong>Admin</strong> menambahkan program beasiswa baru: <strong>"Beasiswa Prestasi Akademik"</strong>
                                    </div>
                                </div>
                                <div class="tl-item">
                                ...
                                <div class="tl-item">
                                    ...
                                    <div class="tl-card" style="border-left-color: #ef4444;">
                                        <strong>Admin</strong> menonaktifkan akun verifikator <strong>Budi Hartono</strong>.
                                    </div>
                                </div>
                                <div class="tl-item">
