...
<style>
    ...
    /* ═══ Badges ═══ */
    .bdg { display:inline-flex; align-items:center; gap:5px; border-radius:50px; padding:4px 12px; font-size:.73rem; font-weight:700; }
    ...
    .bdg-purple { background:#ede9fe; color:#7c3aed; }
    .bdg-slate  { background:#f1f5f9; color:#475569; }
    ...
    /* ═══ Section ═══ */
    .sec-label { font-size:.72rem; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#1d4ed8; margin-bottom:6px; }
    .sec-title { font-size:clamp(1.4rem,2.5vw,1.9rem); font-weight:800; color:#0f172a; line-height:1.25; }
    ...
    .program-card:hover { box-shadow:0 20px 50px rgba(29,78,216,.08); }
    ...
    .pc-identity { display:flex; align-items:flex-start; gap:18px; flex-wrap:wrap; }
    .pc-icon-wrap {
        width:60px; height:60px; border-radius:16px;
        display:flex; align-items:center; justify-content:center;
        font-size:1.6rem; flex-shrink:0;
    }
    .pc-name    { font-size:1.35rem; font-weight:800; color:#0f172a; margin-bottom:4px; }
    .pc-sponsor { font-size:.82rem; color:#64748b; }
    ...
    .detail-cell {
        background:#f8faff; border:1px solid #eef2ff; border-radius:14px;
        padding:16px; text-align:center;
    }
    .dc-val { font-size:1.25rem; font-weight:800; line-height:1; margin-bottom:4px; }
    .dc-lbl { font-size:.72rem; color:#64748b; }

    /* ─── Coverage List ─── */
    .coverage-list { list-style:none; padding:0; margin:0; display:grid; grid-template-columns:repeat(auto-fit,minmax(200px,1fr)); gap:8px; }
    .coverage-list li {
        font-size:.84rem; color:#374151; display:flex; align-items:center; gap:8px;
        padding:8px 12px; border-radius:10px; background:#f8faff; border:1px solid #eef2ff;
    }
    .coverage-list li i { color:#1d4ed8; flex-shrink:0; }
    ...
    .acc-premium .accordion-item:hover { box-shadow:0 4px 16px rgba(29,78,216,.06); }
    .acc-premium .accordion-button {
        font-weight:700; font-size:.9rem; color:#0f172a !important;
        background:#fff !important; border-radius:14px !important;
        padding:16px 20px; box-shadow:none !important;
    }
    .acc-premium .accordion-button:not(.collapsed) {
        color:#1d4ed8 !important; background:#f8faff !important;
    }
    .acc-premium .accordion-button::after { filter:none; }
    .acc-premium .accordion-button:not(.collapsed)::after { filter:invert(30%) sepia(90%) saturate(600%) hue-rotate(200deg); }
    .acc-premium .accordion-body {
        font-size:.85rem; color:#4b5563; line-height:1.75;
        padding:0 20px 18px; background:#f8faff;
    }
    .acc-premium .accordion-body ul { padding-left:1.2rem; margin-bottom:0; }
    .acc-premium .accordion-body li { margin-bottom:6px; }
    ...
    .alur-title { font-weight:700; font-size:.85rem; color:#0f172a; margin-bottom:2px; }
    .alur-desc  { font-size:.8rem; color:#64748b; line-height:1.6; margin:0; }

    /* ─── Doc Chips ─── */
    .doc-chip {
        display:inline-flex; align-items:center; gap:6px;
        background:#f8faff; border:1px solid #e0e9ff; border-radius:10px;
        padding:8px 14px; font-size:.8rem; font-weight:600; color:#374151;
        transition: all .2s;
    }
    .doc-chip:hover { background:#dbeafe; border-color:#93c5fd; }
    .doc-chip i { color:#1d4ed8; }

    /* ═══ Compare Table ═══ */
    .compare-table { border-radius:18px; overflow:hidden; border:1px solid #e8edf5; }
    .compare-table thead th {
        background:#0f172a; color:#fff; font-size:.8rem; font-weight:700;
        padding:14px 18px; border:none; text-align:center;
        letter-spacing:.3px;
    }
    .compare-table thead th:first-child { text-align:left; background:#1e293b; }
    .compare-table tbody td {
        padding:14px 18px; font-size:.83rem; color:#374151;
        text-align:center; border-bottom:1px solid #f1f5f9;
        vertical-align:middle;
    }
    .compare-table tbody td:first-child { text-align:left; font-weight:600; color:#0f172a; }
    ...
    /* ═══ CTA ═══ */
    .btn-cta-primary {
        background:linear-gradient(135deg,#1d4ed8,#0a58ca); color:#fff; border:none;
        border-radius:12px; padding:12px 24px; font-weight:700; font-size:.9rem;
        transition:all .25s; box-shadow:0 4px 14px rgba(29,78,216,.3);
    }
    .btn-cta-primary:hover { transform:translateY(-1px); box-shadow:0 6px 20px rgba(29,78,216,.4); color:#fff; }
    ...
    @media(max-width:767.98px) {
        .pc-header, .pc-body { padding:20px; }
        ...
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-4">
                <div class="d-flex gap-3 justify-content-lg-end flex-wrap">
                    <div class="text-center px-3 py-3 rounded-4" style="background:rgba(255,255,255,.1);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.15)">
    ...
    <div class="container py-2">
        ...
        <div class="program-card fade-up">
            <div class="pc-header">
                ...
                <div class="pc-identity">
                    <div class="pc-icon-wrap" style="background:#dbeafe;color:#1d4ed8"><i class="bi bi-trophy-fill"></i></div>
                    <div class="flex-grow-1">
                        <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                            <h2 class="pc-name mb-0">Beasiswa Full Funded</h2>
                        ...
                        <div class="pc-sponsor">
                            ...
                            <span class="bdg bdg-blue" style="padding:2px 8px;font-size:.65rem"><i class="bi bi-star-fill"></i> Paling Diminati</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="pc-body">
                <p style="font-size:.9rem;color:#4b5563;line-height:1.75;max-width:700px">
                    Beasiswa Full Funded menanggung <strong>seluruh biaya pendidikan</strong> mahasiswa selama masa studi aktif,
                ...
                <div class="accordion acc-premium" id="accFull">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fullReq">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fullAlur">
                        ...
                        <div id="fullAlur" class="accordion-collapse collapse" data-bs-parent="#accFull">
                            <div class="accordion-body">
                                <div class="alur-step">
                                    ...
                                    <div><div class="alur-title">Pendaftaran Eksternal</div><p class="alur-desc">Daftarkan diri ke program beasiswa eksternal (Dikti, KIP, dll.) sesuai syarat masing-masing.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#6366f1">2</div>
                                    <div><div class="alur-title">Unggah SK ke Sistem</div><p class="alur-desc">Setelah dinyatakan lolos, unggah Surat Keputusan (SK) penerima ke sistem beasiswa YARSI.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#7c3aed">3</div>
                                    <div><div class="alur-title">Validasi Kaprodi</div><p class="alur-desc">Kaprodi memeriksa kelengkapan data dan kesesuaian akademik mahasiswa.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#16a34a">4</div>
                                    <div><div class="alur-title">Verifikasi Admin</div><p class="alur-desc">Admin pusat melakukan verifikasi akhir keaslian dokumen dan kesesuaian data sistem.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#0e7490">5</div>
                                    <div><div class="alur-title">Persetujuan Warek</div><p class="alur-desc">Wakil Rektor / Kepala Pusat memberikan persetujuan final dan menetapkan status.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#b45309">6</div>
                                    <div><div class="alur-title">Status Aktif</div><p class="alur-desc">Beasiswa dikonfirmasi aktif dan mahasiswa menerima notifikasi resmi melalui sistem.</p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fullDoc">
                        ...
                        <div id="fullDoc" class="accordion-collapse collapse" data-bs-parent="#accFull">
                            <div class="accordion-body">
                                <div class="d-flex flex-wrap gap-2">
                                    <span class="doc-chip"><i class="bi bi-file-earmark-pdf-fill"></i> Surat Keputusan (SK)</span>
                                    <span class="doc-chip"><i class="bi bi-file-earmark-text-fill"></i> Transkrip Nilai</span>
                                    <span class="doc-chip"><i class="bi bi-person-badge-fill"></i> KTM Aktif</span>
                                    <span class="doc-chip"><i class="bi bi-file-earmark-check-fill"></i> Surat Aktif Kuliah</span>
                                    <span class="doc-chip"><i class="bi bi-file-earmark-medical-fill"></i> SKTM / Surat Keterangan</span>
                                    <span class="doc-chip"><i class="bi bi-image-fill"></i> Pas Foto 3×4</span>
                                </div>
                                <div class="mt-3 p-3 rounded-3" style="background:#fffbeb;border:1px solid #fde68a;font-size:.8rem;color:#92400e">
                                    <i class="bi bi-exclamation-triangle-fill me-2"></i>
                                    Semua file harus berformat <strong>PDF</strong> dengan ukuran maksimal <strong>5 MB</strong> per file.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4 d-flex gap-3 flex-wrap">
                    <a href="{{ route('login') }}" class="btn-cta-primary"><i class="bi bi-box-arrow-in-right me-2"></i>Daftar Sekarang</a>
                    <a href="{{ route('guest.faq') }}" class="btn btn-outline-secondary rounded-3 fw-semibold" style="font-size:.88rem"><i class="bi bi-question-circle me-1"></i>Lihat FAQ</a>
                </div>
            </div>
        </div>
        ...
        <div class="program-card fade-up">
            <div class="pc-header">
                ...
                <div class="pc-identity">
                    <div class="pc-icon-wrap" style="background:#ede9fe;color:#7c3aed"><i class="bi bi-award-fill"></i></div>
                    <div class="flex-grow-1">
                        <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                        ...
                        <div class="pc-sponsor">
                            ...
                            <span class="mx-2 text-muted">•</span>
                            <span class="bdg bdg-purple" style="padding:2px 8px;font-size:.65rem"><i class="bi bi-graph-up-arrow"></i> Populer</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="pc-body">
                ...
                <div class="accordion acc-premium" id="accPartial">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#partReq">
                                <i class="bi bi-clipboard-check-fill text-primary me-2"></i>Persyaratan Pendaftaran
                            </button>
                        </h2>
                        <div id="partReq" class="accordion-collapse collapse" data-bs-parent="#accPartial">
                            <div class="accordion-body">
                                <ul>
                                    ...
                                    <li>Boleh menerima beasiswa lain <em>selama tidak bertumpang tindih</em> pada komponen biaya yang sama</li>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#partAlur">
                                <i class="bi bi-diagram-3-fill text-primary me-2"></i>Alur Pendaftaran
                            </button>
                        </h2>
                        <div id="partAlur" class="accordion-collapse collapse" data-bs-parent="#accPartial">
                            <div class="accordion-body">
                                <div class="alur-step">
                                    ...
                                    <div><div class="alur-title">Pendaftaran Internal / Eksternal</div><p class="alur-desc">Daftarkan diri melalui sistem YARSI atau melalui mitra beasiswa yang bekerja sama.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#8b5cf6">2</div>
                                    <div><div class="alur-title">Unggah Berkas Pendukung</div><p class="alur-desc">Upload transkrip nilai, surat rekomendasi, dan dokumen pendukung lainnya.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#a855f7">3</div>
                                    <div><div class="alur-title">Validasi Kaprodi</div><p class="alur-desc">Kaprodi memeriksa kelayakan akademik dan merekomendasikan mahasiswa.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#16a34a">4</div>
                                    <div><div class="alur-title">Verifikasi & Persetujuan</div><p class="alur-desc">Admin dan Warek melakukan verifikasi final dan menetapkan besaran bantuan.</p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#partDoc">
                                <i class="bi bi-folder-fill text-primary me-2"></i>Dokumen Pendukung
                            </button>
                        </h2>
                        <div id="partDoc" class="accordion-collapse collapse" data-bs-parent="#accPartial">
                            <div class="accordion-body">
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <span class="doc-chip"><i class="bi bi-person-badge-fill"></i> KTM Aktif</span>
                                    <span class="doc-chip"><i class="bi bi-file-earmark-check-fill"></i> Surat Aktif Kuliah</span>
                                    <span class="doc-chip"><i class="bi bi-chat-square-text-fill"></i> Surat Rekomendasi DPA</span>
                                    <span class="doc-chip"><i class="bi bi-image-fill"></i> Pas Foto 3×4</span>
                                </div>
                                <div class="mt-3 p-3 rounded-3" style="background:#fffbeb;border:1px solid #fde68a;font-size:.8rem;color:#92400e">
                                    <i class="bi bi-exclamation-triangle-fill me-2"></i>
                                    Format <strong>PDF</strong>, maks. <strong>5 MB</strong> per file. Transkrip harus memperlihatkan IPK dengan jelas.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4 d-flex gap-3 flex-wrap">
                    <a href="{{ route('login') }}" class="btn-cta-primary" style="background:linear-gradient(135deg,#7c3aed,#6d28d9)"><i class="bi bi-box-arrow-in-right me-2"></i>Daftar Sekarang</a>
                    <a href="{{ route('guest.faq') }}" class="btn btn-outline-secondary rounded-3 fw-semibold" style="font-size:.88rem"><i class="bi bi-question-circle me-1"></i>Lihat FAQ</a>
                </div>
            </div>
        </div>
        ...
        <div class="program-card fade-up">
            <div class="pc-header">
                ...
                <div class="pc-identity">
                    <div class="pc-icon-wrap" style="background:#fef3c7;color:#b45309"><i class="bi bi-lightning-fill"></i></div>
                    <div class="flex-grow-1">
                        <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
            ...
            <div class="pc-body">
                ...
                <div class="accordion acc-premium" id="accOne">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#oneReq">
                                <i class="bi bi-clipboard-check-fill text-primary me-2"></i>Persyaratan Pendaftaran
                            </button>
                        </h2>
                        <div id="oneReq" class="accordion-collapse collapse" data-bs-parent="#accOne">
                            <div class="accordion-body">
                                <ul>
                                    ...
                                    <li>Memiliki surat keterangan kondisi darurat dari pihak berwenang (RT/RW, Kelurahan, dsb.)</li>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#oneAlur">
                        ...
                        <div id="oneAlur" class="accordion-collapse collapse" data-bs-parent="#accOne">
                            <div class="accordion-body">
                                <div class="alur-step">
                                    ...
                                    <div><div class="alur-title">Pengajuan Online</div><p class="alur-desc">Isi formulir pengajuan One Shot melalui sistem dan unggah dokumen pendukung.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#f97316">2</div>
                                    <div><div class="alur-title">Review Kaprodi</div><p class="alur-desc">Kaprodi melakukan verifikasi singkat dan memberikan rekomendasi.</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#16a34a">3</div>
                                    <div><div class="alur-title">Persetujuan Cepat</div><p class="alur-desc">Admin dan Warek melakukan persetujuan prioritas (maks. 3 hari kerja).</p></div>
                                </div>
                                <div class="alur-step">
                                    <div class="alur-num" style="background:#1d4ed8">4</div>
                                    <div><div class="alur-title">Pencairan Dana</div><p class="alur-desc">Dana bantuan dicairkan langsung ke rekening mahasiswa yang bersangkutan.</p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#oneDoc">
                                <i class="bi bi-folder-fill text-primary me-2"></i>Dokumen Pendukung
                            </button>
                        </h2>
                        <div id="oneDoc" class="accordion-collapse collapse" data-bs-parent="#accOne">
                            <div class="accordion-body">
                                <div class="d-flex flex-wrap gap-2">
                                    <span class="doc-chip"><i class="bi bi-file-earmark-pdf-fill"></i> Surat Keterangan Darurat</span>
                                    <span class="doc-chip"><i class="bi bi-file-earmark-text-fill"></i> Transkrip Nilai</span>
                                    <span class="doc-chip"><i class="bi bi-person-badge-fill"></i> KTM Aktif</span>
                                    <span class="doc-chip"><i class="bi bi-chat-square-text-fill"></i> Rekomendasi DPA/Kaprodi</span>
                                    <span class="doc-chip"><i class="bi bi-credit-card-fill"></i> Fotokopi Rekening</span>
                                </div>
                                <div class="mt-3 p-3 rounded-3" style="background:#dcfce7;border:1px solid #86efac;font-size:.8rem;color:#166534">
                                    <i class="bi bi-info-circle-fill me-2"></i>
                                    Pengajuan One Shot diproses secara <strong>prioritas</strong> — maksimal 3 hari kerja setelah dokumen lengkap.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4 d-flex gap-3 flex-wrap">
                    <a href="{{ route('login') }}" class="btn-cta-primary" style="background:linear-gradient(135deg,#f59e0b,#d97706);box-shadow:0 4px 14px rgba(245,158,11,.3)"><i class="bi bi-box-arrow-in-right me-2"></i>Ajukan Bantuan</a>
                    <a href="{{ route('guest.faq') }}" class="btn btn-outline-secondary rounded-3 fw-semibold" style="font-size:.88rem"><i class="bi bi-question-circle me-1"></i>Lihat FAQ</a>
                </div>
            </div>
        </div>
        ...
        <div class="fade-up mt-5">
            <div class="rounded-4 p-5 text-white text-center position-relative overflow-hidden"
                ...
                <div style="position:absolute;inset:0;background-image:radial-gradient(circle at 30% 50%, rgba(99,102,241,.18) 0%,transparent 50%);pointer-events:none"></div>
                <div class="position-relative">
                    ...
                    <p style="opacity:.75;max-width:480px;margin:0 auto 1.5rem;font-size:.92rem;line-height:1.7">
                        Kunjungi halaman FAQ untuk jawaban lengkap, atau hubungi tim panitia beasiswa kami untuk konsultasi langsung.
                    </p>
