...
@push('styles')
    <style>
        ...
        .review-float-card .rf-name {
            font-size: .78rem;
            font-weight: 700;
            color: #0f172a;
        }

        .review-float-card .rf-role {
            font-size: .7rem;
            color: #94a3b8;
        }
        ...
        .feature-card:hover {
            ...
            box-shadow: 0 20px 48px rgba(29, 78, 216, .1);
        }
        ...
        .schol-card.featured .sc-item {
            color: rgba(255, 255, 255, .8);
        }

        .schol-card.featured .sc-title {
            color: #fff;
        }

        .schol-card:hover:not(.featured) {
            transform: translateY(-4px);
            box-shadow: 0 16px 40px rgba(0, 0, 0, .08);
        }

        .schol-card.featured:hover {
            transform: translateY(-4px);
            box-shadow: 0 20px 50px rgba(29, 78, 216, .4);
        }
            ...
            <div class="row justify-content-center text-center mb-5 fade-up">
                <div class="col-lg-6">
                    ...
                    <p class="sec-sub mx-auto">
                        Kami menghilangkan birokrasi yang rumit agar Anda bisa fokus pada yang terpenting — prestasi
                        akademik.
                    </p>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-sm-6 col-lg-3 fade-up" style="transition-delay:.05s">
                    <div class="feature-card">
                        <div class="fc-icon fc-icon-blue"><i class="bi bi-box-arrow-in-down"></i></div>
                        <h3 class="fc-title">Unggah Dokumen Online</h3>
                        <p class="fc-desc">Upload SK dan berkas pendukung kapan saja, di mana saja, tanpa harus datang ke
                            kantor administrasi.</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 fade-up" style="transition-delay:.1s">
                    <div class="feature-card">
                        ...
                        <p class="fc-desc">Alur persetujuan terstruktur: Kaprodi → Admin → Warek, memastikan transparansi di
                            setiap langkah.</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 fade-up" style="transition-delay:.15s">
                    <div class="feature-card">
                        ...
                        <p class="fc-desc">Pantau status pengajuan secara langsung. Dapatkan pemberitahuan di setiap
                            perubahan status beasiswa Anda.</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3 fade-up" style="transition-delay:.2s">
                    <div class="feature-card">
                        ...
                        <p class="fc-desc">Admin dan pimpinan dapat melihat rekap data beasiswa secara lengkap untuk
                            pengambilan keputusan yang tepat.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4 fade-up" style="transition-delay:.05s">
                    <div class="schol-card featured">
                        ...
                        <h3 class="sc-title">Fully Funded</h3>
                        <p class="sc-desc">Beasiswa penuh yang menanggung seluruh biaya pendidikan selama masa
                            studi.</p>
                        <ul class="sc-items">
                ...
                <div class="col-md-4 fade-up" style="transition-delay:.1s">
                    <div class="schol-card">
                        ...
                        <p class="sc-desc">Bantuan sebagian biaya pendidikan, meringankan beban mahasiswa tanpa menanggung
                            seluruhnya.</p>
                        <ul class="sc-items">
                ...
                <div class="col-md-4 fade-up" style="transition-delay:.15s">
                    <div class="schol-card">
                        ...
                        <p class="sc-desc">Bantuan insidental satu kali untuk mahasiswa yang mengalami kesulitan ekonomi
                            mendadak.</p>
                        <ul class="sc-items">
        ...
        <div class="container position-relative">
            <div class="row justify-content-between align-items-center g-4 fade-up">
                <div class="col-lg-7">
                    ...
                    <p class="mb-0">Bergabunglah bersama lebih dari 1.200 mahasiswa YARSI yang telah merasakan manfaat
                        program beasiswa kami. Proses mudah, transparan, dan terpercaya.</p>
                </div>
