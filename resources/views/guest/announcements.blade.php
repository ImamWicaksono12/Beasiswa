...
@push('styles')
    <style>
        ...
        .timeline::before {
            ...
            bottom: 8px;
            width: 2px;
            background: linear-gradient(to bottom, #1d4ed8, #e0e9ff);
        }
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-5">
                    <div class="d-flex gap-3 justify-content-lg-end flex-wrap">
                        <div class="text-center px-4 py-3 rounded-4"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 fade-up" style="transition-delay:.05s">
                                <div class="schol-open-card">
                                    ...
                                    <p class="mb-0" style="font-size:.8rem;color:#64748b;line-height:1.6">
                                        Beasiswa pemerintah untuk mahasiswa kurang mampu berprestasi. Menanggung biaya UKT
                                        penuh + biaya hidup.
                                    </p>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="progress-thin">
                                            <div class="bar"
                                                style="width:68%;background:linear-gradient(90deg,#1d4ed8,#6366f1)"></div>
                                        </div>
                                    </div>
                                    <a href="{{ route('login') }}" class="btn btn-primary w-100 rounded-3 mt-3 fw-semibold"
                            ...
                            <div class="col-md-6 fade-up" style="transition-delay:.1s">
                                <div class="schol-open-card">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-3 mt-1">
                                        <span class="bdg bdg-purple"><i class="bi bi-award-fill"></i> Partially
                                            Funded</span>
                                        <span class="bdg bdg-green bdg-pulse">Dibuka</span>
                                    </div>
                                    <h3 class="fw-bold mb-1" style="font-size:1rem;color:#0f172a">Beasiswa Yayasan YARSI
                                    </h3>
                                    <p class="mb-0" style="font-size:.8rem;color:#64748b;line-height:1.6">
                                        Bantuan biaya pendidikan 50% dari Yayasan YARSI untuk mahasiswa berprestasi dengan
                                        IPK ≥ 3.25.
                                    </p>
                                    <div class="deadline-bar">
                                        <div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="progress-thin">
                                            <div class="bar"
                                                style="width:60%;background:linear-gradient(90deg,#7c3aed,#a855f7)"></div>
                                        </div>
                                    </div>
                                    <a href="{{ route('login') }}"
                                        class="btn btn-outline-primary w-100 rounded-3 mt-3 fw-semibold"
                                        style="font-size:.85rem">
                                        <i class="bi bi-box-arrow-in-right me-1"></i> Daftar Sekarang
                                    </a>
                                </div>
                            ...
                            <div class="col-md-6 fade-up" style="transition-delay:.15s">
                                <div class="schol-open-card">
                                    ...
                                    <h3 class="fw-bold mb-1" style="font-size:1rem;color:#0f172a">Bantuan Insidental
                                        Semester Genap</h3>
                                    <p class="mb-0" style="font-size:.8rem;color:#64748b;line-height:1.6">
                                        Dana bantuan sekali pemberian untuk mahasiswa yang mengalami kondisi darurat atau
                                        kesulitan tiba-tiba.
                                    </p>
                                    <div class="deadline-bar">
                                        <div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="progress-thin">
                                            <div class="bar"
                                                style="width:48%;background:linear-gradient(90deg,#f59e0b,#f97316)"></div>
                                        </div>
                                    </div>
                                    <a href="{{ route('login') }}"
                                        class="btn btn-outline-warning w-100 rounded-3 mt-3 fw-semibold text-dark"
                                        style="font-size:.85rem">
                            ...
                            <div class="col-md-6 fade-up" style="transition-delay:.2s">
                                <div class="schol-open-card" style="opacity:.75">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-3 mt-1">
                                        ...
                                        <span class="bdg bdg-slate"><i class="bi bi-hourglass-split"></i> Segera
                                            Dibuka</span>
                                    </div>
                                    <h3 class="fw-bold mb-1" style="font-size:1rem;color:#0f172a">LPDP Reguler 2025</h3>
                                    <p class="mb-0" style="font-size:.8rem;color:#64748b;line-height:1.6">
                                        Beasiswa pemerintah untuk jenjang S2/S3 dalam negeri & luar negeri. Akan dibuka
                                        bulan Juni 2025.
                                    </p>
                                    ...
                                    <button class="btn btn-outline-secondary w-100 rounded-3 mt-3 fw-semibold"
                                        style="font-size:.85rem" disabled>
                    ...
                    <div class="mb-5 fade-up">
                        ...
                        <div class="timeline">
                            ...
                            <div class="tl-item fade-up" style="transition-delay:.05s">
                                <div class="tl-dot" style="background:#16a34a;color:#fff"><i class="bi bi-check-lg"
                                        style="font-size:.7rem"></i></div>
                                <div class="tl-card">
                                    ...
                                    <p class="tl-body">Sebanyak <strong>45 mahasiswa</strong> dinyatakan lolos seleksi
                                        administrasi KIP Kuliah Tahap 1. Peserta lolos dimohon untuk melengkapi berkas fisik
                                        paling lambat 10 April 2025.</p>
                                    <div class="d-flex gap-2 mt-3 flex-wrap">
                                        ...
                                        <a href="{{ route('login') }}" class="bdg bdg-blue ms-auto text-decoration-none"><i
                                                class="bi bi-eye-fill"></i> Lihat Daftar</a>
                                    </div>
                                </div>
                            </div>

                            <div class="tl-item fade-up" style="transition-delay:.1s">
                                <div class="tl-dot" style="background:#1d4ed8;color:#fff"><i class="bi bi-check-lg"
                                        style="font-size:.7rem"></i></div>
                                <div class="tl-card">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                                    ...
                                    <h3 class="tl-title">Pengumuman Penerima Beasiswa Yayasan YARSI — Semester Gasal
                                        2024/2025</h3>
                                    <p class="tl-body"><strong>28 mahasiswa</strong> terpilih sebagai penerima Beasiswa
                                        Yayasan YARSI untuk semester gasal 2024/2025. Selamat kepada seluruh penerima!
                                        Pencairan akan dilakukan pada 1 April 2025.</p>
                                    <div class="d-flex gap-2 mt-3 flex-wrap">
                            ...
                            <div class="tl-item fade-up" style="transition-delay:.15s">
                                <div class="tl-dot" style="background:#7c3aed;color:#fff"><i class="bi bi-check-lg"
                                        style="font-size:.7rem"></i></div>
                                <div class="tl-card">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                                        <div class="tl-date"><i class="bi bi-calendar3 me-1"></i>10 Maret 2025</div>
                                        <span class="bdg bdg-purple"><i class="bi bi-check-circle-fill"></i>
                                            Diumumkan</span>
                                    </div>
                                    <h3 class="tl-title">Hasil Verifikasi Dokumen Bantuan Insidental One Shot — Batch Q1
                                        2025</h3>
                                    <p class="tl-body">Proses verifikasi dokumen untuk <strong>Batch Q1 2025</strong> telah
                                        selesai. Dari 25 pengajuan, 18 berhasil diverifikasi dan 7 dikembalikan untuk
                                        perbaikan dokumen.</p>
                                    <div class="d-flex gap-2 mt-3 flex-wrap">
                                        <span class="bdg bdg-green">18 Disetujui</span>
                                        <span class="bdg bdg-amber">7 Revisi Dokumen</span>
                                        <a href="{{ route('login') }}" class="bdg bdg-blue ms-auto text-decoration-none"><i
                                                class="bi bi-eye-fill"></i> Lihat Detail</a>
                                    </div>
                                </div>
                            </div>

                            <div class="tl-item fade-up" style="transition-delay:.2s">
                                <div class="tl-dot" style="background:#94a3b8;color:#fff"><i class="bi bi-clock-fill"
                                        style="font-size:.55rem"></i></div>
                                <div class="tl-card" style="border-style:dashed;background:#fafbff">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                                        <div class="tl-date"><i class="bi bi-calendar3 me-1"></i>Dijadwalkan: 10 Mei 2025
                                        </div>
                                        <span class="bdg bdg-slate"><i class="bi bi-hourglass-split"></i> Akan Datang</span>
                                    </div>
                                    <h3 class="tl-title">Pengumuman Hasil Seleksi KIP Kuliah Tahap 2 — Semester Genap
                                        2024/2025</h3>
                                    <p class="tl-body text-muted">Pengumuman tahap 2 dijadwalkan pada 10 Mei 2025. Pastikan
                                        Anda telah melengkapi semua dokumen persyaratan sebelum tanggal tersebut.</p>
                                </div>
                            </div>
                    ...
                    <div class="fade-up">
                        ...
                        <div id="newsList">
                            ...
                            <a href="#" class="news-list-item d-flex" data-category="sistem">
                                <div class="news-icon" style="background:#eff6ff;color:#1d4ed8"><i
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="news-meta">
                                        ...
                                        <span class="bdg bdg-blue" style="padding:2px 8px;font-size:.68rem"><i
                                                class="bi bi-gear-fill"></i> Update Sistem</span>
                                        <span class="bdg bdg-green" style="padding:2px 8px;font-size:.68rem">Baru</span>
                                    </div>
                                    <p class="news-excerpt">Platform baru hadir dengan tampilan yang lebih modern, proses
                                        upload dokumen lebih cepat, dan notifikasi real-time untuk setiap perubahan status
                                        pengajuan beasiswa.</p>
                                </div>
                            ...
                            <a href="#" class="news-list-item d-flex" data-category="berita">
                                <div class="news-icon" style="background:#f0fdf4;color:#15803d"><i
                                        class="bi bi-award-fill"></i></div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                                        <span class="news-title">YARSI Raih Penghargaan Perguruan Tinggi Terbaik dalam
                                            Pengelolaan Beasiswa 2025</span>
                                    </div>
                                    <div class="news-meta">
                                        <span><i class="bi bi-calendar3"></i> 28 Maret 2025</span>
                                        <span class="bdg bdg-green" style="padding:2px 8px;font-size:.68rem"><i
                                                class="bi bi-newspaper"></i> Berita</span>
                                    </div>
                                    <p class="news-excerpt">Universitas YARSI berhasil meraih penghargaan dari
                                        Kemendikbudristek atas keberhasilan dalam pengelolaan dan penyaluran beasiswa
                                        mahasiswa yang transparan dan tepat sasaran.</p>
                                </div>
                                <div class="ms-2 text-muted" style="font-size:.8rem;white-space:nowrap;padding-top:2px">
                                    <i class="bi bi-chevron-right"></i>
                                </div>
                            ...
                            <a href="#" class="news-list-item d-flex" data-category="sistem">
                                <div class="news-icon" style="background:#fffbeb;color:#b45309"><i
                                        class="bi bi-gear-fill"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                                        <span class="news-title">Pemeliharaan Sistem Dijadwalkan 5 April 2025 Pukul
                                            00.00–04.00 WIB</span>
                                    </div>
                                    <div class="news-meta">
                                        <span><i class="bi bi-calendar3"></i> 25 Maret 2025</span>
                                        <span class="bdg bdg-amber" style="padding:2px 8px;font-size:.68rem"><i
                                                class="bi bi-exclamation-triangle-fill"></i> Maintenance</span>
                                    </div>
                                    <p class="news-excerpt">Sistem akan mengalami downtime terjadwal untuk peningkatan
                                        performa server dan pembaruan keamanan. Harap simpan semua pekerjaan sebelum waktu
                                        pemeliharaan.</p>
                                </div>
                                <div class="ms-2 text-muted" style="font-size:.8rem;white-space:nowrap;padding-top:2px">
                                    <i class="bi bi-chevron-right"></i>
                            ...
                            <a href="#" class="news-list-item d-flex" data-category="berita">
                                <div class="news-icon" style="background:#f5f3ff;color:#6d28d9"><i
                                        class="bi bi-people-fill"></i></div>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                                        <span class="news-title">Sosialisasi Program Beasiswa Semester Genap untuk Mahasiswa
                                            Baru</span>
                                    </div>
                                    <div class="news-meta">
                                        <span><i class="bi bi-calendar3"></i> 20 Maret 2025</span>
                                        <span class="bdg bdg-purple" style="padding:2px 8px;font-size:.68rem"><i
                                                class="bi bi-newspaper"></i> Berita</span>
                                    </div>
                                    <p class="news-excerpt">Panitia beasiswa YARSI mengadakan sesi sosialisasi online via
                                        Zoom untuk mahasiswa baru angkatan 2024. Rekaman tersedia di kanal YouTube resmi
                                        YARSI.</p>
                                </div>
                                <div class="ms-2 text-muted" style="font-size:.8rem;white-space:nowrap;padding-top:2px">
                                    <i class="bi bi-chevron-right"></i>
                            ...
                            <a href="#" class="news-list-item d-flex" data-category="sistem">
                                <div class="news-icon" style="background:#fef2f2;color:#991b1b"><i
                                        class="bi bi-exclamation-diamond"></i></div>
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                                                <span class="news-title">Peringatan: Jangan Bagikan Kredensial Akun SSO YARSI kepada
                                                    Siapapun</span>
                                            </div>
                                            <div class="news-meta">
                                                <span><i class="bi bi-calendar3"></i> 15 Maret 2025</span>
                                                <span class="bdg bdg-red" style="padding:2px 8px;font-size:.68rem"><i
                                                        class="bi bi-shield-x"></i> Keamanan</span>
                                            </div>
                                            <p class="news-excerpt">Tim IT mengingatkan seluruh civitas akademika untuk tidak
                                                membagikan username dan password sistem kepada pihak lain. Laporan penipuan
                                                mengatasnamakan panitia beasiswa semakin meningkat.</p>
                                        </div>
                                        <div class="ms-2 text-muted" style="font-size:.8rem;white-space:nowrap;padding-top:2px">
                                            <i class="bi bi-chevron-right"></i>
                                        </div>
                            ...
                            <div class="sidebar-widget fade-up" style="transition-delay:.05s">
                                ...
                                @foreach($deadlines as $dl)
                                    <div class="d-flex align-items-center gap-3 py-2 border-bottom"
                                        style="border-color:#f8fafc!important;font-size:.82rem">
                                        <div class="text-center flex-shrink-0" style="width:38px">
                                            <div class="fw-black" style="font-size:.9rem;color:{{ $dl['color'] }};line-height:1">
                                                {{ explode(' ', $dl['tanggal'])[0] }}
                                            </div>
                                            <div style="font-size:.62rem;color:#94a3b8;text-transform:uppercase">
                                                {{ explode(' ', $dl['tanggal'])[1] }}
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                        ...
                                        <span class="bdg"
                                            style="background:{{ $dl['color'] }}18;color:{{ $dl['color'] }};padding:2px 8px;font-size:.65rem;white-space:nowrap">
                                            {{ $dl['sisa'] }}h
                                        </span>
                                    </div>
                                @endforeach
